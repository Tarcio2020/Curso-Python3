...
Original file is located at
    https://colab.research.google.com/drive/1cd-AzoiwGknZkGFi96PNueCaVTafPBQP
...
if maior_de_idade(idade=pedro.idade):
...
tipo = [type(10), type(1.1), type('EBAC'), type(True), type(None), type([1, 2, 3]), type({1, 2, 3}), type({'janeiro': 1}), type(lambda x: x)]
